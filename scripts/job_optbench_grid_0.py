...
runs the job.  Launch it with::
    ...
    py scripts/kaggle_run.py scripts/job_optbench_grid_0.py --gpu         --accelerator NvidiaTeslaT4         --dataset pankrzysiu/cifar10-python         --dataset <owner>/continuation-core-r20bn-assets         --include continuation_core --include scripts         --timeout-seconds 28800
"""
import os
import runpy
