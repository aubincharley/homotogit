...
runs the job.  Launch it with::
    ...
    py scripts/kaggle_run.py scripts/job_optbench_grid_2.py --gpu         --accelerator NvidiaTeslaT4         --dataset alexandrecorrard/cifar-10-batches-py         --dataset alexandrecorrard/continuation-core-r20bn-assets         --include continuation_core --include scripts         --timeout-seconds 28800
"""
import os
import runpy
