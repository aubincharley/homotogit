...
Dépôt : `adaptative-resolution`, branche `None`, HEAD `None`.
...
|---|---|---|---|
| code | `continuation/experiments/exp0.py` | oui | — |
| code | `continuation/engine.py` | oui | — |
| code | `continuation/transforms/gaussian.py` | oui | — |
| config | `configs/exp0_gaussian.yaml` | oui | — |
| results | `results/exp0_gaussian` | oui | 73 fichiers |
| docs | `docs/experiment0.md` | oui | — |
| docs | `docs/results.md` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/experiments/exp1.py` | oui | — |
| code | `continuation/engine.py` | oui | — |
| config | `configs/exp1_warmstart.yaml` | oui | — |
| results | `results/exp1_gaussian_warmstart` | oui | 43 fichiers |
| docs | `docs/exp1_warmstart.md` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/transforms/tv.py` | oui | — |
| code | `scripts/tv_previews.py` | oui | — |
| results | `results/tv_previews` | oui | 3 fichiers |
| docs | `docs/tv_budget.md` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/transforms/wavelet.py` | oui | — |
| code | `scripts/wavelet_previews.py` | oui | — |
| code | `scripts/wavelet_benchmark.py` | oui | — |
| code | `scripts/wavelet_profile.py` | oui | — |
| code | `scripts/wavelet_optimized_benchmark.py` | oui | — |
| results | `results/wavelet_previews` | oui | 14 fichiers |
| docs | `docs/wavelet_shrinkage.md` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/kaggle_pilot_continuation.py` | oui | — |
| code | `scripts/kaggle_run.py` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/continuation_driver.py` | oui | — |
| code | `scripts/job_plain_study.py` | oui | — |
| code | `scripts/job_gaussian_study.py` | oui | — |
| code | `scripts/job_lr_diagnostic.py` | oui | — |
| code | `scripts/job_lr_control_002.py` | oui | — |
| code | `scripts/audit_gaussian_placement.py` | oui | — |
| code | `scripts/verify_grad_accumulation.py` | oui | — |
| code | `continuation/models/resnet_gn.py` | oui | — |
| config | `scripts/_study_common.py` | oui | — |
...
| results | `results/gaussian_placement_audit.json` | oui | — |
| results | `results/grad_accumulation_check.json` | oui | — |
| results | `results/plain_vs_gaussian_paired.json` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/models/resnet18_bn.py` | oui | — |
| code | `scripts/job_resnet18_gaussian.py` | oui | — |
| code | `scripts/continuation_driver.py` | oui | — |
| results | `results/kaggle_outputs/resnet18-gaussian-20260908-144640` | oui | 5 fichiers |
| results | `results/resnet18_plain_vs_gaussian.png` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/models/resnet20_bn.py` | oui | — |
| code | `scripts/job_resnet20bn_gaussian.py` | oui | — |
| code | `scripts/continuation_driver.py` | oui | — |
| results | `results/kaggle_outputs/resnet20bn-gaussian-20260908-154226` | oui | 8 fichiers |
| results | `results/resnet20bn_plain_vs_gaussian.png` | oui | — |
| results | `results/resnet20bn_pilot_corrected.png` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/job_fulldata_campaign.py` | oui | — |
| code | `scripts/continuation_driver.py` | oui | — |
| results | `results/kaggle_outputs/fulldata-r20bn-20260908-161221` | oui | 22 fichiers |
| results | `results/fulldata_campaign.png` | oui | — |
| docs | `docs/HANDOVER.md` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/job_db2_pilot.py` | oui | — |
| code | `scripts/verify_db2_operator.py` | oui | — |
| code | `continuation/transforms/wavelet.py` | oui | — |
| code | `scripts/continuation_driver.py` | oui | — |
| results | `results/kaggle_outputs/db2-pilot-r20bn-20260908-191741` | oui | 9 fichiers |
| results | `results/db2_operator_verification.json` | oui | — |
| results | `results/db2_pilot.png` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/job_progressive_resolution.py` | oui | — |
| code | `scripts/verify_progressive_resolution.py` | oui | — |
| code | `scripts/plot_progressive_resolution.py` | oui | — |
| code | `continuation/pipeline.py` | oui | — |
| code | `scripts/continuation_driver.py` | oui | — |
| results | `results/kaggle_outputs/progres-r20bn-20260909-075846` | oui | 10 fichiers |
| results | `results/progressive_resolution.png` | oui | — |
| results | `results/progressive_resolution_verification.json` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/campaign_ops.py` | oui | — |
| code | `scripts/campaign_driver.py` | oui | — |
| code | `scripts/campaign_manifest.py` | oui | — |
| code | `scripts/job_campaign.py` | oui | — |
| code | `scripts/job_campaign_0.py` | oui | — |
| code | `scripts/job_campaign_1.py` | oui | — |
| code | `scripts/job_campaign_2.py` | oui | — |
| code | `scripts/verify_campaign_ops.py` | oui | — |
| code | `scripts/stage_campaign_assets.py` | oui | — |
| code | `scripts/analyze_campaign.py` | oui | — |
| code | `scripts/make_presentation.py` | oui | — |
| code | `scripts/presentation_labels.py` | oui | — |
| config | `results/campaign_manifest_frozen.json` | oui | — |
...
| results | `results/campaign_results.json` | oui | — |
| results | `results/campaign_verification.json` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/probe_signals.py` | oui | — |
| code | `scripts/job_adaptive_phase0.py` | oui | — |
| code | `scripts/analyze_adaptive_phase0.py` | oui | — |
| code | `scripts/kaggle_run.py` | oui | — |
| results | `results/kaggle_outputs/adaptive-phase0-20260916-185116` | oui | 134 fichiers |
| results | `results/adaptive_phase0_analysis.json` | oui | — |
| results | `results/adaptive_phase0_analysis.md` | oui | — |
| docs | `docs/adaptive_resolution_plan.md` | oui | — |
...
| code | `continuation/probe_signals.py` | oui | — |
| code | `scripts/job_adaptive_phase0.py` | oui | — |
| code | `scripts/job_adaptive_phase1.py` | oui | — |
| code | `scripts/analyze_adaptive_phase0.py` | oui | — |
...
| code | `continuation/probe_signals.py` | oui | — |
| code | `scripts/job_adaptive_phase0.py` | oui | — |
| code | `scripts/job_adaptive_phase2.py` | oui | — |
| code | `scripts/analyze_adaptive_phase0.py` | oui | — |
...
| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `scripts/job_stl10_resolution.py` | oui | — |
| code | `scripts/job_stl10_controls.py` | oui | — |
| code | `scripts/analyze_stl10_resolution.py` | oui | — |
| code | `continuation/probe_signals.py` | oui | — |
...
| results | `results/stl10_resolution_analysis.md` | oui | — |
| docs | `docs/adaptive_resolution_plan.md` | oui | — |
...
| code | `continuation/probe_signals.py` | oui | — |
| code | `scripts/job_adaptive_phase0.py` | oui | — |
| code | `scripts/job_adaptive_phase3.py` | oui | — |
...
| code | `continuation/probe_signals.py` | oui | — |
| code | `scripts/job_adaptive_phase0.py` | oui | — |
| code | `scripts/job_adaptive_phase4.py` | oui | — |
| code | `scripts/job_adaptive_phase4c.py` | oui | — |
| code | `scripts/job_adaptive_phase5.py` | oui | — |
...
Commit `f191fa6` cité par la fiche EXP-011 : **non résolu** — None.
