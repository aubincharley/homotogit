...
Dépôt : `homotogit`, branche `continuation-gaussian-tv_exploration_1`, HEAD `1cddcbb`.
...
**État du code** : ablation_ops.py ajoute a cote de campaign_ops.py, qui n'est pas modifie ; campaign_driver.py recoit une factory de controleur dispatchee sur un champ de cellule, les deux chemins d'evaluation dans le summary et un appel de diagnostics opt-in, le chemin historique restant inchange par defaut. Assets epingles neufs (INTEGRATION C-43).

| Rôle | Chemin | Présent | Dernier commit |
|---|---|---|---|
| code | `continuation/ablation_ops.py` | oui | efe24dc 2026-09-10 |
| code | `continuation/campaign_ops.py` | oui | b9bb609 2026-09-09 |
| code | `scripts/campaign_driver.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/ablation_manifest.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/ablation2_manifest.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/ablation3_manifest.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/ablation4_manifest.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/ablation5_manifest.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/job_ablation.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/job_ablation2.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/job_ablation3.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/job_ablation4.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/job_ablation5.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/stage_ablation_assets.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/analyze_ablation.py` | oui | 1cddcbb 2026-09-10 |
| code | `scripts/plot_ablation.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/plot_ablation_full.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/plot_ablation_all.py` | oui | efe24dc 2026-09-10 |
| code | `scripts/plot_priors.py` | oui | 1cddcbb 2026-09-10 |
| code | `scripts/plot_seeds.py` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_aa_results.json` | oui | 1cddcbb 2026-09-10 |
| results | `results/ablation_aa_curves.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_aa_synthesis.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_full_curves.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_full_synthesis.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_all_grid.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_all_ranking.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_seeds.png` | oui | efe24dc 2026-09-10 |
| results | `results/ablation_priors.png` | oui | 1cddcbb 2026-09-10 |
| results | `results/ablation_priors_curves.png` | oui | 1cddcbb 2026-09-10 |
